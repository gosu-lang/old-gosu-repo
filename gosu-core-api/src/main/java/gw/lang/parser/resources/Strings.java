   ...
   static final Object[][] contents =
     {
       ...
       {Res.MSG_COMPILE_TIME_CONSTANT_REQUIRED.getKey(), "Expression must be compile-time contant here."},
       ...
       {Res.MSG_NON_LITERAL_ARG_TO_JAVA_ANNOTATION.getKey(), "Compile-time constant expression required."},
