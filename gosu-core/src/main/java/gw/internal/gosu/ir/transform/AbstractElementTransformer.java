...
public abstract class AbstractElementTransformer<T extends IParsedElement>
{
  ...
  public IRExpression pushType( IType type, boolean bKeepLiteralType )
  {
    ...
    {
      FunctionLiteralType funcLiteralType = (FunctionLiteralType)type;
      List<IRExpression> args = new ArrayList<IRExpression>();
      args.add( pushConstant(funcLiteralType.getSerializationClass() ) );
      args.add( pushType( funcLiteralType.getSerializationSuperType() ) );
      args.add( pushType( funcLiteralType.getSerializationReferenceType() ) );
      args.add( pushConstant( funcLiteralType.getSerializationName() ) );
      args.add( pushArrayOfTypes( funcLiteralType.getSerializationParameters() ) );
      return callStaticMethod( FunctionLiteralType.class,
                               "resolve",
                               new Class[]{Class.class, IType.class, IType.class, CharSequence.class, IType[].class},
                               args
                               );
    }
